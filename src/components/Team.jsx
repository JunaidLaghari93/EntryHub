...
function Team() {
  ...
  return (
    <div className={`lg:px-28 md:px-20 px-10 ${isDarkMode ? 'dark' : ''}`}>
      <motion.div
        ...
        <div className="gap-20 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
          <div className="flex flex-col md:mt-20 lg:mt-0 items-stretch max-md:w-full max-md:ml-0">
            <motion.img
              ...
              className="  lg:w-[2000px]  lg:h-[383px] overflow-hidden  max-md:max-w-full max-md:mt-10"
            />
          </div>
          <div className="flex flex-col  max-md:w-full max-md:ml-0">
            <div className="text-black text-justify lg:text-2xl md:text-xl   max-md:max-w-full max-md:mt-10">
              <motion.div
                className="font-extrabold dark:text-[#235191] text-3xl text-center lg:mt-4 uppercase"
          ...
          <div className="flex flex-col md:mt-20 lg:mt-0 items-stretch max-md:w-full max-md:ml-0">
            <motion.img
             ...
             variants={{
              ...
              src={akbar} alt='Akbar'
              className="  lg:w-[2050px] lg:h-[400px] overflow-hidden  max-md:max-w-full max-md:mt-10"
            />
          </div>
          <div className="flex flex-col  max-md:w-full max-md:ml-0">
            <div className="text-black text-justify lg:text-2xl md:text-xl   max-md:max-w-full max-md:mt-10">
              <motion.div
                className="font-extrabold text-3xl dark:text-[#235191] text-center lg:mt-4 uppercase"
