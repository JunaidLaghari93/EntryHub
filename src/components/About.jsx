...
function About() {
  ...
  return (
    <section id='about' className={isDarkMode ? 'dark' : ''}>
      ...
      <motion.div
      className="text-black dark:text-white px-10 md:px-20 lg:px-5 text-justify lg:text-2xl md:text-xl self-center max-w-[1073px] mx-auto mt-10 max-md:max-w-full max-md:mt-10"
          initial="hidden"
          whileInView="visible"
          viewport={{ once : true, amount: 0.5 }}
          transition={{ delay: 0.2, duration: 0.5 }}
