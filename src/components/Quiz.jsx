...
function Quiz() {
  ...
  return (
    ...
    <div id='quiz' className={`lg:px-28 px-10 md:px-20${isDarkMode ? 'dark' : ''}`}>
      ...
      <motion.div 
      className="text-black text-justify dark:text-zinc-400 text-base self-center max-w-[1074px] mt-8 max-md:max-w-full "
      initial="hidden"
      whileInView="visible"
      viewport={{ once: true, amount: 0.5 }}
      ...
      onClick={() => { navigate(("english")) }} className=" text-center cursor-pointer lg:text-2xl md:text-xl font-bold bg-[#3FE0A5] hover:bg-teal-400 hover:text-white self-center lg:w-[300px] md:w-[250px] w-[200px] max-w-full justify-center items-center mt-20 px-16 lg:py-6 md:py-4 py-4 rounded-[32px] ">
        ENGLISH
      </motion.div>
      <motion.div
      initial="hidden"
