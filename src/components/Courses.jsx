...
function Courses() {
  return (
    <div id='courses' className='lg:px-28 md:px-20 px-10'>
      ...
      <div className="self-center w-full max-w-[1075px] mt-20 max-md:max-w-full max-md:mt-10">
          ...
          <div className="flex flex-col items-stretch w-6/12 max-md:w-full max-md:ml-0">
            <motion.img
             ...
             variants={{
              ...
              alt='mdcat'
              src={mdcat}
              className="aspect-[1.53] object-contain object-center w-full overflow-hidden grow max-md:max-w-full max-md:mt-10"
            />
          </div>
