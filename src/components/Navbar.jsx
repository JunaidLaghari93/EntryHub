    ...
    return (
        <>
            <nav className={isDarkMode ? "dark" : ""}>
                <header className={`bg-[#235191] dark:bg-gray-900 self-stretch flex items-center justify-between top-0 p-4 px-10 md:px-20 lg:px-28 fixed left-0 z-50 right-0 ${
